...
export const metadata: Metadata = {
  title: 'Country Wide',
  description: 'Equipment supply and procurement solutions for Healthcare, Oil & Gas, Mining, and Infrastructure.',
};
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50">
      ...
      <section className="relative overflow-hidden min-h-[85vh] md:min-h-[90vh] flex items-center border-b border-slate-200">
        ...
        <div className="container relative z-10 px-4 md:px-6 text-center pt-28 pb-16 md:pt-32 md:pb-24">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight mb-8 text-white max-w-5xl mx-auto">
            Reliable Supply for <span className="text-amber-500">Infrastructure</span>.
          </h1>
          <p className="text-lg sm:text-xl text-slate-400 max-w-4xl mx-auto leading-relaxed mb-10">
            Country Wide specializes in the procurement and supply of high-quality equipment and spare parts for the healthcare, oil and gas, mining, and road construction sectors. We deliver reliable solutions that support operational growth and long-term sustainability.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="border-white/20 text-white hover:bg-white/10 px-8 h-12 text-base font-semibold bg-transparent" asChild>
              <Link href="#solutions">Our Sectors</Link>
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="bg-slate-50 p-10 rounded-3xl border border-slate-100 hover:border-amber-200 hover:shadow-xl transition-all duration-300 group">
              ...
              <h3 className="text-3xl font-bold text-slate-900 mb-4">Equipment Procurement</h3>
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                Dedicated sourcing and procurement for large-scale industrial projects. We focus on reliable supply chains that align with long-term operational goals in critical industries.
              </p>
              <div className="flex flex-wrap gap-3">
                <Badge variant="secondary" className="bg-white hover:bg-slate-100">Global Sourcing</Badge>
                <Badge variant="secondary" className="bg-white hover:bg-slate-100">Quality Assurance</Badge>
              </div>
            </div>
            ...
            <div className="bg-slate-50 p-10 rounded-3xl border border-slate-100 hover:border-amber-200 hover:shadow-xl transition-all duration-300 group">
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                Spare parts supply and logistics solutions designed to accelerate expansion. Keep operations running smoothly with timely access to critical components.
              </p>
              <div className="flex flex-wrap gap-3">
                <Badge variant="secondary" className="bg-white hover:bg-slate-100">Spare Parts Supply</Badge>
                <Badge variant="secondary" className="bg-white hover:bg-slate-100">Logistics Management</Badge>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="container px-4 md:px-6">
          <h2 className="text-3xl font-bold text-slate-900 mb-12 text-center">Sectors We Serve</h2>
